...
Original file is located at
    https://colab.research.google.com/drive/1Hd48dodW69w8UxZqCi6kqhQuY-DXyLJ8
...
cs_id = "israelbenattar"  # @param {type:"string"}
...
denoise_num_res_blocks = 8  # @param {type:"slider", min:1, max:15, step:1}
...
deblur_num_res_blocks = 15  # @param {type:"slider", min:1, max:15, step:1}
...
super_resolution_num_res_blocks = 9  # @param {type:"slider", min:1, max:15, step:1}
batch_size = 100  # @param {type:"slider", min:1, max:128, step:16}
steps_per_epoch = 100  # @param {type:"slider", min:100, max:5000, step:100}
num_epochs = 20  # @param {type:"slider", min:1, max:20, step:1}
patch_size = 10  # @param {type:"slider", min:8, max:32, step:2}
num_channels = 30  # @param {type:"slider", min:16, max:64, step:2}
